            ...
            <div class="nav-item dropdown">
                <?php if ($isLoggedIn) { ?>
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        <a href="<?= site_url('dashboard') ?>" class="dropdown-item">Dasbor</a>
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class=" text-uppercase mb-3 animated slideInDown" style="color: #fb873f;">Platform pembelajaran elektronik terbaik</h5>
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                ...
                                <h1 class="display-3 text-white animated slideInDown">Panduan ahli untuk masa depan cerah!</h1>
            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item text-center pt-3 shadow">
                    <div class="p-4">
                        ...
                        <h5 class="mb-3">Belajar fleksibel</h5>
                        <p>Belajar dengan kecepatan Anda sendiri, berpindah antar kursus, atau beralih ke kursus lain</p>
                    </div>
                </div>
            </div>
...
<!-- Banner-1 End -->
   ...
   <!-- Courses Start -->
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5" style="color: #fb873f;">Jelajahi kursus online gratis yang baru dan sedang tren</h1>
            </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item shadow">
                        ...
                        <div class="p-2 pb-0">
                            ...
                            <h5 class="mb-1"><a href="single.php" class="text-dark">Kursus HTML untuk Pemula </a></h5>
                        </div>
                        <div class="d-flex">
                            <small class="flex-fill text-center py-1 px-2"><i class="fa fa-star text-warning me-2"></i>
                                4.55</small>
                            <small class="flex-fill text-center py-1 px-2"><i class="fa fa-user-graduate me-2"></i>5.8L+Pembelajar</small>
                            <small class="flex-fill text-center py-1 px-2"><i
                                    class="fa fa-user me-2"></i>Pemula</small>
                        </div>
                        <div class="d-flex">
                            <small class="flex-fill text-left p-2 px-2"><i class="fa fa-clock me-2"></i>2 jam</small>
                            <small class="py-1 px-2 fw-bold fs-6 text-center">₹ 0</small>
                            <small class=" text-primary py-1 px-2 fw-bold fs-6" style="float:right;"><a href="#">Daftar Sekarang </a><i class="fa fa-chevron-right me-2 fs-10"></i></small>
                        </div>
                    </div>
                </div>
    ...
    <div class="container text-center">
        <a class="btn text-light py-3 px-5 mt-2 mb-5" href="<?= site_url('courses') ?>">Semua Kursus</a>
    </div>
    <!-- Courses End -->
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 p-5 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4" style="color: #fb873f;">Jadilah Instruktur</h1>
                    <p class="mb-4 text-white">Instruktur dari seluruh dunia mengajar jutaan pelajar di Mora College. Kami menyediakan alat dan keterampilan untuk membantu Anda mengajar apa yang Anda sukai.</p>

                    <a class="btn text-light py-3 mt-2" href="<?= site_url('instructor') ?>">Mulai Mengajar Sekarang</a>
                </div>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                BMC adalah sebuah inisiatif yang menawarkan lebih dari 1000 kursus online gratis dalam teknologi terkini dan telah berhasil mendaftarkan lebih dari 5 juta pelajar di berbagai bidang. BMC mencakup kursus Data Science, Pembelajaran Mesin, Kecerdasan Buatan, Komputasi Awan, Pengembangan Perangkat Lunak, Penjualan dan Pengembangan Bisnis, Pemasaran Digital, Big Data, dan banyak lagi.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                Anda dapat mengklik tombol “Daftar” di pojok kanan atas halaman dan mendaftar menggunakan alamat email Anda, atau masuk menggunakan Akun Google.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                Apa saja kursus gratis paling populer yang ditawarkan oleh BMC?
                            </button>
                        </h2>
                        <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <ul>
                                    <li>Kursus Gratis Data Science</li>
                                    <li>Kursus Gratis Kecerdasan Buatan</li>
                                    <li>Kursus Gratis Pemrograman/Perangkat Lunak</li>
                                    <li>Kursus Gratis Komputasi Awan</li>
                                </ul>
                            </div>
                        </div>
                    </div>
